					...
					<div class="col-md-8 profile-body">
						<div class="profile-info">
							...
							@foreach($users as $user)
	                            @if($user->id == $posts->users_id)
									@if(Auth::user()->id == $user->id)
										<a href="{{ URL::to('/editpost/' . $posts->id) }}" class="pull-right"><i class="icon-edit"></i> Edit Post</a>
									@endif
								@endif
                        	@endforeach
						...
						<div class="col-md-12">
								<div class="panel panel-archon panel-chat ">
									<div class="panel-heading">
										<h3 class="panel-title">Comment Box
									...
									<div class="panel-body">
										<div class="message-column">
											<div class="user-block">
													<i class="icon-coffee text-info"></i>
											...
											<div class="messages">
												<ul class="list-unstyled">
													...
													<li>
														<img src="/images/displayphotos/{{$user->display_photo}}" alt="" class="avatar">
														
														<form role="form" action="/post/{{$comment->id}}/delete" method="post">
														<input type="hidden" name="_token" value="{{ csrf_token() }}">
														...
														<div class="message">
															...
															<span class="time pull-right">
																...
																<button type = "" class = "btn btn-xs btn-default glyphicon glyphicon-remove"> </button>
																@endif
															</span>
															<p>
																{{$comment->content}}
												...
												<form role="form" action="/post/{id}" method="POST">
													...
													<div class="input-group">
														...
														<span class="input-group-btn">
															<button type="submit" class="btn btn-info message-send">Post</button>
														</span>
													</div><!-- /input-group -->
												</form>
											</div>
