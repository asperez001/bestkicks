...
class UserController extends Controller {
	...
	public function index()
	{
		...
		return view('bestkicks.userprofile', compact('brands','sizes','conditions',
			'colors','types','locations', 'location', 'user_type'));
	}
	...
	{
		$users = User::all();
		return view ('bestkicks.editpassword', compact('users'));
	}
	...
	public function show($id)
	{
		...
		return view('user.profile', compact('brands','sizes','conditions','username',
			'colors','types','locations', 'location', 'user','mode','posts','user_type'));
	}
	...
	{
		$users = User::all();
		return view('user.sellers', compact('users'));
	}

	public function indexbuyer()
	{
		$users = User::all();
		return view('user.buyers', compact('users'));
	}
