...
class PostController extends Controller {
	...
	public function show($id)
	{
		...
		return view('post.show', compact('posts', 'brands','sizes','conditions',
			'colors','types','locations', 'users','mode','comments'));
	}
	...
	public function myposts()
	{
		...
		return view('post.user', compact('brands','sizes','conditions',
			'colors','types','locations', 'posts', 'users', 'username','mode'));
	}
	...
	public function all()
	{
		...
		if(isset($flocations)){
			...
			'colors','types','locations', 'users','mode'));
	}
	...
	{
		$post = Post::all();
		return view('post.pending', compact('post'));
	}

	public function indexapproved()
	{
		$post = Post::all();
		return view('post.approved', compact('post'));
	}
